...
export const en = {
    ...
    cheatsPage: {
        ...
        viewCards: "Card view",
        typedOnly: "Typed only",
        typedOnlyHint: "Show only prompts you typed yourself (hide unprovable legacy prompts).",
        provenanceLegacy: "legacy",
        provenanceLegacyHint:
            "From before Claude Code stamped prompt origin — can't be proven typed by you.",
        sourceLabel: "Source",
        sourceTyped: "Typed by you",
        sourceLegacy: "Legacy (origin unprovable)",
